...
/*
    ...
    Fecha: 18-03-2025
    Resumen: Realiza la conexión a la base de datos y recoge la liga del URL. Se obtienen las divisiones y jornadas para poder aplicar filtros.
    Extrae de la tabla partidos aquellos partidos con estado procesado o aceptado y los muestra en una tabla .
*/
...
<body>
    ...
    <button class="volver" onclick="window.location.href='administrar-ligas-activas.php'">Volver atrás</button>
