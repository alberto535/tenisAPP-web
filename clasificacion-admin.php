...
/*
    ...
    Fecha: 17-03-2025
    Resumen: Realiza la conexión a la base de datos y recoge la liga desde el URL. Precarga las divisiones que encontramos en la liga,
    y llama a otro archivo para mostrar una tabla con la division seleccionada y la liga.
*/
...
// Obtener la división de los usuarios en la liga especificada
...
<body>
    ...
    <script>
        function cargarClasificacion() {
            ...
            $.ajax({
                url: "obtener-clasificacion-admin.php",
                method: "GET",
